from parsernfa import parse_nfa
...
#               [lab]--[entrance]--[start]
#
# Grid 5 linii x 28 coloane
# row 0: final(0,0)  garden(0,4)
# row 1:                  |
# row 2:             workshop(2,4)  library(2,8)
# row 3:                                  |
# row 4:             lab(4,4)  entrance(4,8)  start(4,12)
...
CONEXIUNI = [
    ((0,0), (0,4),  "─"),  # final - garden
    ((0,4), (2,4),  "│"),  # garden - workshop
    ((2,4), (2,8),  "─"),  # workshop - library
    ((2,8), (4,8),  "│"),  # library - entrance
    ((4,4), (4,8),  "─"),  # lab - entrance
    ((4,8), (4,12), "─"),  # entrance - start
]
...
def deseneaza_harta(stare_curenta, inventar):
    ...
    for nome, (r, c, label) in ETICHETE.items():
        # eticheta pe randul de dedesubt sau deasupra
